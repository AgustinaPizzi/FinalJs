...
const mostrarProductos = (productos) => {
  ...
  productos.forEach((producto) => {
    ...
    boton.addEventListener("click", () => {
      ...
      // Aquí necesitamos los productos nuevamente. Una opción es hacer un nuevo fetch dentro de la función. La otra opción es enviar los productos desde aquí, ya que en mostrar productos sí conocemos el array porque estamos en un fetch
...
/* --------------------------------- LÓGICA --------------------------------- */
// Primero traemos los productos del JSON local
fetch("./js/productos.json")
  .then((response) => response.json())
  .then((productos) => {
    // Cuando los productos están disponibles, recién allí mostrarmos los productos y actualizamos el carrito
